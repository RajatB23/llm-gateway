package com.gateway.adapter.openai;
...
public class OpenAiAdapter implements ProviderAdapter {
    ...
    public OpenAiAdapter(OpenAiProviderProperties properties, ObjectMapper objectMapper) {
    ...
    public String chatCompletionsPath(boolean stream) {
        return properties.baseUrl() + "/v1/chat/completions";
    }
